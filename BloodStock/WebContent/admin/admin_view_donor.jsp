              ...
              <tr>
                ...
                <tr>
                  <td height="33" align="center" valign="middle">
					  ...
					  <%
					  	ArrayList<DonorDTO> donors = AdminBL.getRequestedDonors();
					  ...
					  %>
					    <table width="80%" border="1" align="center"  border>
					      <tbody style="">
					        <tr>
					          ...
					          <td width="10%" align="center" valign="middle" ><span style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">Height</span></td>
					           ...
					           <td width="10%" align="center" valign="middle" ><span style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">Action</span></td>
					          ...
					          %>
					        <tr>
					          <td height="30"><%= donor.getDonor_id() %>&nbsp;</td>
					          <td><%= donor.getDonor_name() %>&nbsp;</td>
					          <td><%=donor.getBlood_grp()%>&nbsp;</td>
					          <td align="left" valign="middle" style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">&nbsp;<%=donor.getGender() %></td>
					          <td><%=  donor.getDob() %>&nbsp;</td>
					          <td align="left" valign="middle"><%= donor.getPhone() %>&nbsp;</td>
					          <td align="left" valign="middle"><%= donor.getHeight() %>&nbsp;</td>
				              <td align="left" valign="middle"><%= donor.getWeight() %>&nbsp;</td>
				              <td align="left" valign="middle"><%= donor.getDod() %>&nbsp;</td>
				              
					          <td align="left" valign="middle"><a href ="admin_accept_process.jsp?donor_id=<%=donor.getDonor_id()%>">Accept</a>&nbsp;</td>
					          <% 
					  	...
					  	else
					  	{
					          %>
					          <tr>
					          <td valign="middle" colspan="7">No donor Details Found</td>
					          </tr>
					  <%
					  	}
					  %>
